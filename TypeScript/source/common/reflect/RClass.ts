module sk.common.reflect {
   ...
   export class RClass {
      //..........................................................
      // @attribute
      private static _codes: any = new Array();
      ...
      //==========================================================
      public static isBase(value) {
         if (value != null) {
            var typeName = typeof (value);
            return this.isBaseName(typeName);
         }
         return false;
      }
      ...
      // @return Boolean 是否基础类型
      //==========================================================
      public static isBaseName(typeName) {
         if (typeName != null) {
            if (typeName == 'boolean') {
               return true;
      ...
      //==========================================================
      public static isBaseDataName(typeName) {
         if (typeName != null) {
            if (typeName == 'boolean') {
               return true;
            } else if (typeName == 'number') {
      ...
      // @return Boolean 是否基础类型
      //==========================================================
      public static isBaseType(clazz) {
         if (clazz != null) {
            if (clazz == Boolean) {
               return true;
      ...
      // @return Boolean 是否基础数据类型
      //==========================================================
      public static isBaseDataType(clazz) {
         if (clazz != null) {
            if (clazz == Boolean) {
               return true;
            } else if (clazz == Number) {
      ...
      //    <L value='false'>否</L>
      //==========================================================
      public static isName(value, name) {
      ...
      public static checkClass(v, c) {
         if (!this.isClass(v, c)) {
            throw new Error('Invalid class ' + this.name(this) + '<>' + this.name(c));
         }
      }
      ...
      public static inherits(s, p) {
         var base = sk.common.runtime.RRuntime.nvl(p, s);
      ...
      public static build(clazz) {
         ...
         //..........................................................
         // 删除类中所有空属性
         if (sk.common.runtime.RRuntime.isRelease()) {
      ...
      // @return String 调试信息
      //==========================================================
      public static dump(v) {
         // 对象为空的情况
         if (v == null) {
            return '@null';
         }
         // 对象为一般实例的情况
         var t = this.safeTypeOf(v);
         switch (t) {
            case 'Boolean':
               // 数字的情况
               return 'Boolean:' + v;
            ...
            case 'Function':
               // 字符串的情况
               return t + '<' + RMethod.name(v) + '>@' + this.code(v);
            case 'Html':
               // HTML对象的情况
               return t + '<' + v.tagName + '>@' + this.code(v);
            default:
               if (v.__name) {
                  return t + '<' + v.__name + '>@' + this.code(v);
               }
         }
         return t + '@' + this.code(v);
      }
   }
}
