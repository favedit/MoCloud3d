module sk.common.xml {
   ...
   // @version 141229
   //==========================================================
   export class FNode extends sk.common.lang.FObject {
      //..........................................................
      // @attribute
      ...
      //==========================================================
      public isName(n) {
         return sk.common.lang.RString.equals(this._name, n);
      }
      ...
      public attributes() {
         ...
         var r = o._attributes;
         if (!r) {
            r = o._attributes = new sk.common.lang.FAttributes();
         }
         return r;
      }
      ...
      public nodes() {
         ...
         var nodes = o._nodes;
         if (!nodes) {
            nodes = o._nodes = new sk.common.lang.FObjects();
         }
         return nodes;
      }
      ...
      public getInteger(name, defaultValue) {
         return sk.common.lang.RInteger.parse(this.get(name, defaultValue));
      }
      ...
      public setNvl(name, value) {
         if (!sk.common.lang.RString.isEmpty(value)) {
            this.attributes().set(name, value);
         }
      }
      ...
      public setBoolean(n, v) {
         if (v != null) {
            this.attributes().set(n, sk.common.lang.RBoolean.format(v));
         }
      }
      ...
      public setFloat(n, v) {
         if (v != null) {
            this.attributes().set(n, sk.common.lang.RFloat.format(v));
         }
      }
      ...
      public findNode(pn, pv) {
         ...
         if (o.hasNode()) {
            ...
            var ac = as.length;
            if ((ac - 1) % 2) {
               throw new sk.common.lang.FError(this, 'Attributes is not pair. (length={1})', ac);
            }
            // 查找所有节点
      ...
      public innerDump(dump, node, space) {
         ...
         dump.append(space, node._name, '(', sk.common.reflect.RClass.name(node), ')');
      ...
      public dump(d: any = null, space: string = null) {
         return this.innerDump(sk.common.lang.RString.nvlString(d), this, space);
      }
   }
}