module sk.common.tag {
   ...
   // @version 150114
   //==========================================================
   export class FTag extends sk.common.lang.FObject {
      //..........................................................
      // @attribute
      protected _name = 'Tag';
      ...
      //==========================================================
      public onBegin(p) {
         return sk.common.lang.EResult.Continue;
      }
      ...
      //==========================================================
      public set(n, v) {
         throw new sk.common.lang.FError(this, 'Unknown attribute name. (name={1}, value={2})', n, v);
      }
      ...
      public push(p) {
         ...
         var ts = o._children;
         if (ts == null) {
            ts = o._children = new sk.common.lang.FObjects();
         }
         ts.push(p);
      }
      ...
      public parse(p) {
         ...
         // 开始处理
         var r = o.onBegin(p);
         if (r == sk.common.lang.EResult.Continue) {
            // 子标签处理
            var ts = o._children;
            if (ts) {
               var c = ts.count();
               for (var i = 0; i < c; i++) {
                  var t = ts.get(i);
                  r = t.parse(p);
                  if (r == sk.common.lang.EResult.Cancel) {
                     return r;
                  }
      ...
      public innerDump(ps, pt, pl) {
         var o = this;
         ps.appendRepeat('   ', pl);
         ps.append(sk.common.reflect.RClass.dump(pt));
         // 追加属性
         var s = pt.toString();
