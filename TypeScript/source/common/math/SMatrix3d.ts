...
public parse(translation, scale, skew, perspective, quaternion){
      ...
      public saveConfig(p) {
         var o = this;
         p.set('tx', sk.common.lang.RFloat.format(o.tx));
         p.set('ty', sk.common.lang.RFloat.format(o.ty));
         p.set('tz', sk.common.lang.RFloat.format(o.tz));
         p.set('rx', sk.common.lang.RFloat.format(o.rx));
         p.set('ry', sk.common.lang.RFloat.format(o.ry));
         p.set('rz', sk.common.lang.RFloat.format(o.rz));
         p.set('sx', sk.common.lang.RFloat.format(o.sx));
         p.set('sy', sk.common.lang.RFloat.format(o.sy));
         p.set('sz', sk.common.lang.RFloat.format(o.sz));
      }
   }
}