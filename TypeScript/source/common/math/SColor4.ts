module sk.common.math {
   ...
   export class SColor4 {
      ...
      public setHex(value) {
         ...
         if (value.length == 6) {
            o.red = sk.common.lang.RHex.parse(value.substring(0, 2)) / 255;
            o.green = sk.common.lang.RHex.parse(value.substring(2, 4)) / 255;
            o.blue = sk.common.lang.RHex.parse(value.substring(4, 6)) / 255;
         } else {
            throw new sk.common.lang.FError(o, 'Invalid value.');
         }
      }
      ...
      //============================================================
      public toRGBAString() {
         return 'rgba(' + parseInt((this.red * 255) as any) + ',' + parseInt((this.green * 255) as any) + ',' + parseInt((this.blue * 255) as any) + ',' + sk.common.lang.RFloat.format(this.alpha) + ')';
      }
      ...
      //============================================================
      public toString() {
         return sk.common.lang.RFloat.format(this.red) + ',' + sk.common.lang.RFloat.format(this.green) + ',' + sk.common.lang.RFloat.format(this.blue) + ',' + sk.common.lang.RFloat.format(this.alpha);
      }
