module sk.common.lang {
   ...
   export class TObjects {
      ...
      protected _items: Array<any> = new Array<any>();
      ...
      public dump(): string {
         ...
         result.append(sk.common.runtime.RRuntime.className(this), ':', count);
         if (count) {
            for (var i = 0; i < count; i++) {
