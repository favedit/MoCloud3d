   ...
   export class FXmlConnection extends FHttpConnection {
      ...
      public onConnectionSend() {
         ...
         if (data) {
            ...
            if (data.constructor == String) {
               xml = data;
               o._inputNode = null;
            } else if (data.constructor == sk.common.xml.FXmlNode) {
               var document = new sk.common.xml.FXmlDocument();
               document.setRoot(data);
               xml = document.xml();
               o._inputNode = data;
            } else if (data.constructor == sk.common.xml.FXmlDocument) {
               xml = data.xml();
               o._inputNode = data.root();
            } else {
               throw new sk.common.lang.FError(o, 'Unknown send data type.');
            }
            o._inputData = xml;
      ...
      public onConnectionComplete() {
         ...
         if (handle.responseXML) {
            ...
            throw new sk.common.lang.FError(o, "Fetch xml data failure.");
         }
         if (!element) {
         ...
         // 建立文档对象
         var document = new sk.common.xml.FXmlDocument();
         sk.common.xml.RXml.buildNode(document, null, element);
