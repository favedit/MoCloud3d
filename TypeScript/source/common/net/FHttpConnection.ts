module sk.common.net {
   ...
   // @version 150104
   //==========================================================
   export class FHttpConnection extends sk.common.lang.FObject {
      // @attribute
      ...
      public onConnectionSend() {
         ...
         if (input) {
            if (input.constructor == String) {
               ...
               throw new sk.common.lang.FError(this, 'Unknown send data type.');
            }
         }
      }
         ...
         if (o._asynchronous) {
            ...
            if (handle.readyState == EHttpStatus.Loaded) {
               if (handle.status == 200) {
                  ...
                  sk.common.lang.RLogger.fatal(o, 'Connection failure. (url={1})', o._url);
               }
            }
         }
      }
      ...
      public constructor() {
         super();
         // 设置属性
         this._heads = new sk.common.lang.FAttributes();
      ...
      public sendSync() {
         ...
         o.setOutputData();
         o.onConnectionComplete();
         sk.common.lang.RLogger.info(this, 'Send http sync request. (method={1}, url={2})', o._methodCd, o._url);
      }
      ...
      public dispose() {
         var o = this;
         // 释放属性
         o._heads = sk.common.lang.RObject.dispose(o._heads);
         o._attributes = sk.common.lang.RObject.dispose(o._attributes);
         o._event = sk.common.lang.RObject.dispose(o._event);
         o._input = null;
         o._inputData = null;
         o._output = null;
         o._outputData = null;
