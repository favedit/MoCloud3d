module sk.common.net {
   ...
   // @history 15029
   //==========================================================
   export class FSocket extends sk.common.lang.FObject {
      // @attribute
      ...
      public constructor() {
         super();
         // 设置属性
         this._eventOpen = new sk.common.lang.SEvent(this);
         this._eventSend = new sk.common.lang.SEvent(this);
         this._eventReceive = new sk.common.lang.SEvent(this);
         this._eventClose = new sk.common.lang.SEvent(this);
         this._eventError = new sk.common.lang.SEvent(this);
      }
      ...
      public dispose() {
         // 释放属性
         this._eventOpen = sk.common.lang.RObject.dispose(this._eventOpen);
         this._eventSend = sk.common.lang.RObject.dispose(this._eventSend);
         this._eventReceive = sk.common.lang.RObject.dispose(this._eventReceive);
         this._eventClose = sk.common.lang.RObject.dispose(this._eventClose);
         this._eventError = sk.common.lang.RObject.dispose(this._eventError);
         this._handle = null;
         // 父处理
         super.dispose();
      }
