module sk.graphic.context3d {
   ...
   export class FG3dLayout extends FG3dObject {
      ...
      protected _buffers: sk.common.lang.FObjects = null;
      //o._samplers = MO.Class.register(o, new MO.AGetter('_samplers'));
      protected _samplers: sk.common.lang.FObjects = null;
      ...
      public linkBuffers(buffers) {
         ...
         if (!buffers.isEmpty()) {
            ...
            if (!items) {
               items = o._buffers = new sk.common.lang.FObjects();
            }
      ...
      public linkSamplers(samplers) {
         ...
         if (!samplers.isEmpty()) {
            ...
            if (!items) {
               items = o._samplers = new sk.common.lang.FObjects();
            }
      ...
      public dispose() {
         // 释放对象
         this._buffers = sk.common.lang.RObject.dispose(this._buffers);
         this._samplers = sk.common.lang.RObject.dispose(this._samplers);
         // 父处理
         super.dispose();
      }
   }
