module sk.graphic.context3d {
   ...
   // @history 150107
   //==========================================================
   export class FG3dEffectConsole extends sk.core.FConsole {
      // @attribute
      ...
      public register(name, effect) {
         ...
         sk.common.runtime.RAssert.debugNotNull(effect);
      ...
      public create(context, name) {
         ...
         if (!clazz) {
            throw new sk.common.lang.FError(this, 'Unknown effect type name. (type={1})', clazz);
         }
         var effect = sk.common.reflect.RClass.create(clazz);
      ...
      public buildEffectInfo(context, effectInfo, region, renderable) {
         ...
         for (var i = 0; i < count; i++) {
            ...
            if (sk.common.lang.RString.isEmpty(vertexCode)) {
               throw new sk.common.lang.FError(o, 'Vertex buffer code is empty.');
            }
         ...
         if (textures) {
            ...
            for (var i = 0; i < count; i++) {
               ...
               if (sk.common.lang.RString.isEmpty(textureCode)) {
                  throw new sk.common.lang.FError(o, 'Texture code is empty.');
               }
      ...
      public findTemplate(context, code) {
         ...
         if (effect == null) {
            ...
            effect.load();
            sk.common.lang.RLogger.info(o, 'Create effect template. (code={1}, instance={2})', code, effect);
            // 存储效果器
      ...
      public find(context, region, renderable) {
         ...
         if (sk.common.lang.RString.isEmpty(effectCode)) {
         ...
         if (effectTemplate) {
            ...
            if (!effect) {
               ...
               sk.common.lang.RLogger.info(o, 'Create effect. (name={1}, instance={2})', effectCode, effect);
            }
            // 存储效果器
