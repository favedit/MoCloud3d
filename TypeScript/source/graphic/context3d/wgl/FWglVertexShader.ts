module sk.graphic.context3d.wgl {
   ...
   // @history 141230
   //==========================================================
   export class FWglVertexShader extends sk.graphic.context3d.FG3dVertexShader {
      // @attribute
      _handle = null;
      ...
      public upload(source) {
         ...
         if (!result) {
            ...
            o._handle = null;
            throw new sk.common.lang.FError(o, 'Upload vertex shader source failure. (error={1})\n{2}', info, source);
         }
         o._source = source;
         return true;
      }
