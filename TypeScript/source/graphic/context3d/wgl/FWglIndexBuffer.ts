module sk.graphic.context3d.wgl {
   ...
   // @history 141230
   //==========================================================
   export class FWglIndexBuffer extends sk.graphic.context3d.FG3dIndexBuffer {
      //..........................................................
      // @attribute
      ...
      public upload(data, count, remain) {
         ...
         if ((data.constructor == Array) || (data.constructor == ArrayBuffer)) {
            if (o._strideCd == EG3dIndexStride.Uint16) {
               ...
               throw new sk.common.lang.FError(o, 'Index stride is invalid.');
            }
         } else if (data.constructor == Uint16Array) {
            if (o._strideCd != EG3dIndexStride.Uint16) {
               throw new sk.common.lang.FError(o, 'Index stride16 is invalid.');
            }
            memory = data;
            ...
            throw new sk.common.lang.FError(o, 'Upload index data type is invalid. (value={1})', data);
         }
         // 上传数据
