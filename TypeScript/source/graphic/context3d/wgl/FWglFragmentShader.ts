module sk.graphic.context3d.wgl {
   ...
   // @history 141230
   //==========================================================
   export class FWglFragmentShader extends sk.graphic.context3d.FG3dFragmentShader {
      // @attribute
      _handle = null;
      ...
      public upload(source) {
         ...
         if (!result) {
            ...
            o._handle = null;
            throw new sk.common.lang.FError(o, 'Upload fragment shader source failure. (error={1})\n{2}', info, source);
         }
         o._source = source;
         return true;
      }
