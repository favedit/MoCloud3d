module sk.graphic.context3d {
   ...
   // @history 150106
   //==========================================================
   export class FG3dAnimation extends sk.common.lang.FObject {
      // @attribute
      protected _baseTick = 0;
      protected _currentTick = 0;
      protected _lastTick = 0
      protected _bones = new sk.common.lang.FObjects();
      ...
      //==========================================================
      public dispose() {
         this._bones = sk.common.lang.RObject.dispose(this._bones);
         super.dispose();
      }
   }
}