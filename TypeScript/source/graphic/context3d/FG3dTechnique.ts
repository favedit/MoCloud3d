module sk.graphic.context3d {
   ...
   export class FG3dTechnique extends FG3dObject {
      ...
      protected _modes: sk.common.lang.FObjects = new sk.common.lang.FObjects();
      //_passes = MO.Class.register(o, new MO.AGetter('_passes'));
      protected _passes: sk.common.lang.FObjects = new sk.common.lang.FObjects();
      ...
      public registerMode(p) {
         var o = this;
         var m = sk.common.reflect.RClass.create(FG3dTechniqueMode);
         m.setCode(p);
         o._modes.push(m);
         o._activeMode = m;
         return m;
      ...
      public pushPass(pass) {
         var o = this;
         sk.common.runtime.RAssert.debugNotNull(pass);
         pass.setTechnique(o);
         o._passes.push(pass);
      }
