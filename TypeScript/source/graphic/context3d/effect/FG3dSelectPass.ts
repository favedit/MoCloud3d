module sk.graphic.context3d.effect {
   //==========================================================
   // <T>阴影深度渲染过程。</T>
   //
   // @author maocy
   // @history 141230
   //==========================================================
   export class FG3dSelectPass extends sk.graphic.context3d.FG3dTechniquePass {
      private static EG3dSamplerFilter = sk.graphic.context3d.EG3dSamplerFilter;
      // @attribute
      ...
      protected _position: sk.common.math.SPoint2 = new sk.common.math.SPoint2();
      ...
      public activeEffects(region, renderables) {
         ...
         for (var i = 0; i < count; i++) {
            ...
            if (renderable.optionSelect()) {
               ...
               if (!info.effect) {
                  info.effect = sk.core.RConsole.find(sk.graphic.context3d.FG3dEffectConsole).find(o._graphicContext, region, renderable);
               }
            }
         }
      }
