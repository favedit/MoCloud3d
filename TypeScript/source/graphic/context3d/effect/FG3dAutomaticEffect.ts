module sk.graphic.context3d.effect {
   ...
   // @history 150114
   //==========================================================
   export class FG3dAutomaticEffect extends sk.graphic.context3d.FG3dEffect {
      private static EG3dAttribute = sk.graphic.context3d.EG3dAttribute;
      // @attribute
      ...
      public buildInfo(tagContext, info) {
         ...
         // 获得参数
         var flag = new sk.common.lang.FString();
      ...
      public drawRenderable(region, renderable, index:number = 0) {
         ...
         if (indexCount > 1) {
            ...
            throw new sk.common.lang.FError(o, 'Index buffer is not found.');
         }
