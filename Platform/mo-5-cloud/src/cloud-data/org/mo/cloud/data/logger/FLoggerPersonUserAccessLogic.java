      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FLoggerPersonUserAccessUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FLoggerPersonUserAccessUnit>(FLoggerPersonUserAccessUnit.class, _logicContext);
   }
