...
//============================================================
@ASourceMachine
public class FDataFinancialUserUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段权限代码集合的定义。
   private String __roleCodes;

   // 字段权限代码集合的定义。
   protected String _roleCodes;
   ...
   // @return 数据内容
   //============================================================
   public boolean isRoleCodesChanged(){
      return !RString.equals(__roleCodes, _roleCodes);
   }
   ...
   //============================================================
   @Override
   public FDataFinancialUserUnit clone(){
      FDataFinancialUserUnit unit = RClass.newInstance(FDataFinancialUserUnit.class);
      copy(unit);
      return unit;
   }
}
