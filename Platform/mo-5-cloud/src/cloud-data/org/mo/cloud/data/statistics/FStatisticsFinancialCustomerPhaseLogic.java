      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FStatisticsFinancialCustomerPhaseUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FStatisticsFinancialCustomerPhaseUnit>(FStatisticsFinancialCustomerPhaseUnit.class, _logicContext);
   }
