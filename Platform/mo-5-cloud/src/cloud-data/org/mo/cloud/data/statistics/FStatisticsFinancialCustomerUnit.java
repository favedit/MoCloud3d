      ...
      extends FLogicUnit
{
   ...
   // 存储字段最低投标编号的定义。
   private long __tenderLowerId;

   // 字段最低投标编号的定义。
   protected long _tenderLowerId;

   // 存储字段最低投标关联编号的定义。
   private long __tenderLowerLinkId;

   // 字段最低投标关联编号的定义。
   protected long _tenderLowerLinkId;

   // 存储字段最低投标模式的定义。
   private String __tenderLowerModel;

   // 字段最低投标模式的定义。
   protected String _tenderLowerModel;

   // 存储字段最低投标年化的定义。
   private float __tenderLowerRate;

   // 字段最低投标年化的定义。
   protected float _tenderLowerRate;
   ...
   // @return 数据内容
   //============================================================
   public boolean isTenderLowerIdChanged(){
      return __tenderLowerId != _tenderLowerId;
   }
   ...
   // @return 数据内容
   //============================================================
   public long tenderLowerId(){
      return _tenderLowerId;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTenderLowerId(long value){
      _tenderLowerId = value;
   }

   //============================================================
   // <T>判断最低投标关联编号的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   public boolean isTenderLowerLinkIdChanged(){
      return __tenderLowerLinkId != _tenderLowerLinkId;
   }
   ...
   // @return 数据内容
   //============================================================
   public long tenderLowerLinkId(){
      return _tenderLowerLinkId;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTenderLowerLinkId(long value){
      _tenderLowerLinkId = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTenderLowerModelChanged(){
      return !RString.equals(__tenderLowerModel, _tenderLowerModel);
   }
   ...
   // @return 数据内容
   //============================================================
   public String tenderLowerModel(){
      return _tenderLowerModel;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTenderLowerModel(String value){
      _tenderLowerModel = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTenderLowerRateChanged(){
      return __tenderLowerRate != _tenderLowerRate;
   }
   ...
   // @return 数据内容
   //============================================================
   public float tenderLowerRate(){
      return _tenderLowerRate;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTenderLowerRate(float value){
      _tenderLowerRate = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "tender_lower_id":
            return Long.toString(_tenderLowerId);
         case "tender_lower_link_id":
            return Long.toString(_tenderLowerLinkId);
         case "tender_lower_model":
            return _tenderLowerModel;
         case "tender_lower_rate":
            return RFloat.toString(_tenderLowerRate);
         case "tender_id":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "performance_total":
            ...
            break;
         case "tender_lower_id":
            _tenderLowerId = RLong.parse(value);
            break;
         case "tender_lower_link_id":
            _tenderLowerLinkId = RLong.parse(value);
            break;
         case "tender_lower_model":
            _tenderLowerModel = value;
            break;
         case "tender_lower_rate":
            _tenderLowerRate = RFloat.parse(value);
            break;
         case "tender_id":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "performance_total":
               ...
               break;
            case "tender_lower_id":
               __tenderLowerId = RLong.parse(value);
               _tenderLowerId = __tenderLowerId;
               break;
            case "tender_lower_link_id":
               __tenderLowerLinkId = RLong.parse(value);
               _tenderLowerLinkId = __tenderLowerLinkId;
               break;
            case "tender_lower_model":
               __tenderLowerModel = value;
               _tenderLowerModel = __tenderLowerModel;
               break;
            case "tender_lower_rate":
               __tenderLowerRate = RFloat.parse(value);
               _tenderLowerRate = __tenderLowerRate;
               break;
            case "tender_id":
   ...
   public void save(FRow row){
      ...
      row.set("tenderLowerId", _tenderLowerId);
      row.set("tenderLowerLinkId", _tenderLowerLinkId);
      row.set("tenderLowerModel", _tenderLowerModel);
      row.set("tenderLowerRate", _tenderLowerRate);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("tenderLowerId", RLong.toString(_tenderLowerId));
      map.put("tenderLowerLinkId", RLong.toString(_tenderLowerLinkId));
      map.put("tenderLowerModel", _tenderLowerModel);
      map.put("tenderLowerRate", RFloat.toString(_tenderLowerRate));
   ...
   public void unserialize(IDataInput input){
      ...
      _tenderLowerId = input.readInt64();
      _tenderLowerLinkId = input.readInt64();
      _tenderLowerModel = input.readString();
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt64(_tenderLowerId);
      output.writeInt64(_tenderLowerLinkId);
      output.writeString(_tenderLowerModel);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setTenderLowerId(_tenderLowerId);
      unit.setTenderLowerLinkId(_tenderLowerLinkId);
      unit.setTenderLowerModel(_tenderLowerModel);
      unit.setTenderLowerRate(_tenderLowerRate);
