      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataResourceModelAnimationTrackUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataResourceModelAnimationTrackUnit>(FDataResourceModelAnimationTrackUnit.class, _logicContext);
   }
