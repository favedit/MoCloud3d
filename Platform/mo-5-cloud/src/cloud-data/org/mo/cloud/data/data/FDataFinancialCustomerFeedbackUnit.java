...
//============================================================
@ASourceMachine
public class FDataFinancialCustomerFeedbackUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段反馈时间的定义。
   private TDateTime __remindedDate = new TDateTime();

   // 字段反馈时间的定义。
   protected TDateTime _remindedDate = new TDateTime();
   ...
   // <T>构造客户跟进记录表逻辑单元。</T>
   //============================================================
   public FDataFinancialCustomerFeedbackUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isRemindedDateChanged(){
      return !__remindedDate.equals(_remindedDate);
   }
   ...
   // @return 数据内容
   //============================================================
   public TDateTime remindedDate(){
      return _remindedDate;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setRemindedDate(TDateTime value){
      _remindedDate = value;
   }
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "record_date":
               ...
               break;
            case "reminded_date":
               __remindedDate.parse(value);
               _remindedDate.assign(__remindedDate);
               break;
            case "note":
               __note = value;
               _note = __note;
   ...
   public void save(FRow row){
      ...
      row.set("remindedDate", _remindedDate);
      row.set("note", _note);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("remindedDate", _remindedDate.format("YYYY-MM-DD HH24:MI:SS"));
      map.put("note", _note);
   ...
   public void unserialize(IDataInput input){
      ...
      _remindedDate.set(input.readInt64());
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt64(_remindedDate.get());
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.remindedDate().assign(_remindedDate);
      unit.setNote(_note);
   ...
   //============================================================
   @Override
   public FDataFinancialCustomerFeedbackUnit clone(){
      FDataFinancialCustomerFeedbackUnit unit = RClass.newInstance(FDataFinancialCustomerFeedbackUnit.class);
      copy(unit);
      return unit;
   }
}
