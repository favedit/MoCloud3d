...
//============================================================
@ASourceMachine
public class FDataFinancialRanklistUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造排行榜类型逻辑单元。</T>
   //============================================================
   public FDataFinancialRanklistUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataFinancialRanklistUnit clone(){
      FDataFinancialRanklistUnit unit = RClass.newInstance(FDataFinancialRanklistUnit.class);
      copy(unit);
      return unit;
   }
}
