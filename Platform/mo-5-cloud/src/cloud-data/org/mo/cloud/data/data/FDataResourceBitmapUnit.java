      ...
      extends FLogicUnit
{
   ...
   // 存储字段协议代码的定义。
   private String __mimeCode;

   // 字段协议代码的定义。
   protected String _mimeCode;
   ...
   // @return 数据内容
   //============================================================
   public boolean isMimeCodeChanged(){
      return !RString.equals(__mimeCode, _mimeCode);
   }
