      ...
      extends FLogicTable
{
   ...
   // 字段数据大小的定义。
   public final static SLogicFieldInfo DATA_SIZE = new SLogicFieldInfo("DATA_SIZE");

   // 字段数据校验的定义。
   public final static SLogicFieldInfo DATA_HASH = new SLogicFieldInfo("DATA_HASH");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`USER_ID`,`PROJECT_ID`,`CATALOG_ID`,`RESOURCE_CD`,`CODE`,`LABEL`,`KEYWORDS`,`SHARE_CD`,`HAS_PREVIEW`,`ICON_URL`,`DATA_SIZE`,`DATA_HASH`,`DESCRIPTION`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`ICON_URL`");
      cmd.append(",`DATA_SIZE`");
      cmd.append(",`DATA_HASH`");
      ...
      cmd.append(',');
      cmd.append(unit.dataSize());
      cmd.append(',');
      String dataHash = unit.dataHash();
      if(RString.isEmpty(dataHash)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(dataHash));
         cmd.append('\'');
      }
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isDataSizeChanged()){
         cmd.append(",`DATA_SIZE`=");
         cmd.append(unit.dataSize());
      }
      if(unit.isDataHashChanged()){
         cmd.append(",`DATA_HASH`=");
         String dataHash = unit.dataHash();
         if(RString.isEmpty(dataHash)){
            cmd.append("NULL");
