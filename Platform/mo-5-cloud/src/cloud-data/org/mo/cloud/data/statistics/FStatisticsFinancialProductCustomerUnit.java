...
//============================================================
@ASourceMachine
public class FStatisticsFinancialProductCustomerUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造统计产品客户表逻辑单元。</T>
   //============================================================
   public FStatisticsFinancialProductCustomerUnit(){
   }
   ...
   //============================================================
   @Override
   public FStatisticsFinancialProductCustomerUnit clone(){
      FStatisticsFinancialProductCustomerUnit unit = RClass.newInstance(FStatisticsFinancialProductCustomerUnit.class);
      copy(unit);
      return unit;
   }
}
