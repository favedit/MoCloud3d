      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`USER_ID`,`PROJECT_ID`,`RESOURCE_ID`,`CODE`,`LABEL`,`CONTENT`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataResourceMaterialUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataResourceMaterialUnit>(FDataResourceMaterialUnit.class, _logicContext);
   }
