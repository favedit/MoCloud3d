...
//============================================================
@ASourceMachine
public class FLoggerFinancialCustomerActionLogic
      extends FLogicTable
{
   // 金融客户行为记录的定义。
   ...
   // 金融客户行为记录的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.financial.customer.action", "LG_FIN_CUSTOMER_ACTION");
   ...
   // <T>构造金融客户行为记录逻辑单元。</T>
   //============================================================
   public FLoggerFinancialCustomerActionLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerFinancialCustomerActionUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerFinancialCustomerActionLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerFinancialCustomerActionUnit.class;
   }
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FLoggerFinancialCustomerActionUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FLoggerFinancialCustomerActionUnit>(FLoggerFinancialCustomerActionUnit.class, _logicContext);
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerFinancialCustomerActionUnit findByGuid(CharSequence guid){
      return findByGuid(null, FLoggerFinancialCustomerActionUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerFinancialCustomerActionUnit search(CharSequence whereSql){
      return search(null, FLoggerFinancialCustomerActionUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerFinancialCustomerActionUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerFinancialCustomerActionUnit> fetch(int pageSize,
                                                                  int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerFinancialCustomerActionUnit> fetch(CharSequence fields,
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerFinancialCustomerActionUnit> fetchSql(CharSequence code,
                                                                     CharSequence sql,
                                                                     int pageSize,
                                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerFinancialCustomerActionUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerFinancialCustomerActionUnit doPrepare(){
      FLoggerFinancialCustomerActionUnit unit = new FLoggerFinancialCustomerActionUnit();
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FLoggerFinancialCustomerActionUnit unit = (FLoggerFinancialCustomerActionUnit)logicUnit;
      unit.setOvld(true);
