      ...
      extends FLogicUnit
{
   ...
   // 存储字段产品比率的定义。
   private float __productRate;

   // 字段产品比率的定义。
   protected float _productRate;
   ...
   public boolean isProductRateChanged(){
      return __productRate != _productRate;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setProductRate(float value){
      _productRate = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "product_rate":
            return RFloat.toString(_productRate);
         case "borrow_status":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "end_date":
            ...
            break;
         case "product_rate":
            _productRate = RFloat.parse(value);
            break;
         case "borrow_status":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "end_date":
               ...
               break;
            case "product_rate":
               __productRate = RFloat.parse(value);
               _productRate = __productRate;
               break;
            case "borrow_status":
   ...
   public void save(FRow row){
      ...
      row.set("productRate", _productRate);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("productRate", RFloat.toString(_productRate));
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setProductRate(_productRate);
