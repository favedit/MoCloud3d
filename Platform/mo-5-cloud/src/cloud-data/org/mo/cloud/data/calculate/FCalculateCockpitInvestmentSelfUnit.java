...
//============================================================
@ASourceMachine
public class FCalculateCockpitInvestmentSelfUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造金融大额自投逻辑单元。</T>
   //============================================================
   public FCalculateCockpitInvestmentSelfUnit(){
   }
   ...
   //============================================================
   @Override
   public FCalculateCockpitInvestmentSelfUnit clone(){
      FCalculateCockpitInvestmentSelfUnit unit = RClass.newInstance(FCalculateCockpitInvestmentSelfUnit.class);
      copy(unit);
      return unit;
   }
}
