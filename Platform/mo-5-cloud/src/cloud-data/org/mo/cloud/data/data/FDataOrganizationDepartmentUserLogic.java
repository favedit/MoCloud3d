      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataOrganizationDepartmentUserUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataOrganizationDepartmentUserUnit>(FDataOrganizationDepartmentUserUnit.class, _logicContext);
   }
