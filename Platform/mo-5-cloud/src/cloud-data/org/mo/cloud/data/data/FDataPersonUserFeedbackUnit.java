...
//============================================================
@ASourceMachine
public class FDataPersonUserFeedbackUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段命名标识的定义。
   private int __anonymousCd;

   // 字段命名标识的定义。
   protected int _anonymousCd;
   ...
   // <T>构造人员公告访问逻辑单元。</T>
   //============================================================
   public FDataPersonUserFeedbackUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isAnonymousCdChanged(){
      return __anonymousCd != _anonymousCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setAnonymousCd(int value){
      _anonymousCd = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "anonymous_cd":
            return RInteger.toString(_anonymousCd);
         case "record_date":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "user_id":
            ...
            break;
         case "anonymous_cd":
            _anonymousCd = RInteger.parse(value);
            break;
         case "record_date":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "anonymous_cd":
               __anonymousCd = RInteger.parse(value);
               _anonymousCd = __anonymousCd;
               break;
            case "record_date":
   ...
   public void save(FRow row){
      ...
      row.set("anonymousCd", _anonymousCd);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("anonymousCd", RInteger.toString(_anonymousCd));
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt32(_anonymousCd);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setAnonymousCd(_anonymousCd);
   ...
   //============================================================
   @Override
   public FDataPersonUserFeedbackUnit clone(){
      FDataPersonUserFeedbackUnit unit = RClass.newInstance(FDataPersonUserFeedbackUnit.class);
      copy(unit);
      return unit;
   }
}
