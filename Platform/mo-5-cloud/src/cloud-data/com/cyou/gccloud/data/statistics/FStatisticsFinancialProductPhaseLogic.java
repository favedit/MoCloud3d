...
//============================================================
@ASourceMachine
public class FStatisticsFinancialProductPhaseLogic
      extends FLogicTable
{
   // 统计产品阶段表的定义。
   ...
   // 统计产品阶段表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("statistics.financial.product.phase", "ST_FIN_PRODUCT_PHASE");
   ...
   // @param context 逻辑环境
   //============================================================
   public FStatisticsFinancialProductPhaseLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FStatisticsFinancialProductPhaseUnit.class;
   }
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FStatisticsFinancialProductPhaseUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FStatisticsFinancialProductPhaseUnit>(FStatisticsFinancialProductPhaseUnit.class, _logicContext);
   }
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductPhaseUnit findByGuid(CharSequence guid){
      return findByGuid(null, FStatisticsFinancialProductPhaseUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductPhaseUnit search(CharSequence whereSql){
      return search(null, FStatisticsFinancialProductPhaseUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductPhaseUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductPhaseUnit> fetch(int pageSize,
                                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductPhaseUnit> fetch(CharSequence fields,
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductPhaseUnit> fetchSql(CharSequence code,
                                                                       CharSequence sql,
                                                                       int pageSize,
                                                                       int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductPhaseUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductPhaseUnit doPrepare(){
      FStatisticsFinancialProductPhaseUnit unit = new FStatisticsFinancialProductPhaseUnit();
