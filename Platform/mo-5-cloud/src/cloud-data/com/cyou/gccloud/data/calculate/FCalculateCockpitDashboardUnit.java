...
//============================================================
@ASourceMachine
public class FCalculateCockpitDashboardUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造仪表盘逻辑单元。</T>
   //============================================================
   public FCalculateCockpitDashboardUnit(){
   }
   ...
   //============================================================
   @Override
   public FCalculateCockpitDashboardUnit clone(){
      FCalculateCockpitDashboardUnit unit = RClass.newInstance(FCalculateCockpitDashboardUnit.class);
      copy(unit);
      return unit;
   }
}
