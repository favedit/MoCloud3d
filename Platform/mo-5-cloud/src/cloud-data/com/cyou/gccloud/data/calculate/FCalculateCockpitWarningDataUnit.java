...
//============================================================
@ASourceMachine
public class FCalculateCockpitWarningDataUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造驾驶舱预警数据表逻辑单元。</T>
   //============================================================
   public FCalculateCockpitWarningDataUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isContentIdChanged(){
      return __contentId != _contentId;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "content_id":
            return Long.toString(_contentId);
         case "parameter1":
            return _parameter1;
         case "parameter2":
            return _parameter2;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "rule_id":
               ...
               break;
            case "content_id":
               __contentId = RLong.parse(value);
               _contentId = __contentId;
               break;
            case "parameter1":
               __parameter1 = value;
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("contentId", RLong.toString(_contentId));
   ...
   //============================================================
   @Override
   public FCalculateCockpitWarningDataUnit clone(){
      FCalculateCockpitWarningDataUnit unit = RClass.newInstance(FCalculateCockpitWarningDataUnit.class);
      copy(unit);
      return unit;
   }
}
