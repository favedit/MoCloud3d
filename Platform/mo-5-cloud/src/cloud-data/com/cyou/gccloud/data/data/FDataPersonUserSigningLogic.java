      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataPersonUserSigningUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataPersonUserSigningUnit>(FDataPersonUserSigningUnit.class, _logicContext);
   }
