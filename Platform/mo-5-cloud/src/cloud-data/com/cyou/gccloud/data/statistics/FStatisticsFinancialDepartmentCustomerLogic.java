      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FStatisticsFinancialDepartmentCustomerUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FStatisticsFinancialDepartmentCustomerUnit>(FStatisticsFinancialDepartmentCustomerUnit.class, _logicContext);
   }
