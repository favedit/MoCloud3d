      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`CODE`,`LABEL`,`ICON_URL`,`ACTIVE_CD`,`RATE`,`HORIZON_COUNT`,`HORIZON_UNIT`,`HORIZON_CLOSED`,`HORIZON_WAIT`,`FACTOR`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataFinancialProductUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataFinancialProductUnit>(FDataFinancialProductUnit.class, _logicContext);
   }
