...
//============================================================
@ASourceMachine
public class FLoggerFinancialCustomerActionUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造金融客户行为记录逻辑单元。</T>
   //============================================================
   public FLoggerFinancialCustomerActionUnit(){
   }
   ...
   //============================================================
   @Override
   public FLoggerFinancialCustomerActionUnit clone(){
      FLoggerFinancialCustomerActionUnit unit = RClass.newInstance(FLoggerFinancialCustomerActionUnit.class);
      copy(unit);
      return unit;
   }
}
