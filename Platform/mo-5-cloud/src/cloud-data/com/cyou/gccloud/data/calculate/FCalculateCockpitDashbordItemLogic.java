...
//============================================================
@ASourceMachine
public class FCalculateCockpitDashbordItemLogic
      extends FLogicTable
{
   // 仪表盘数据表的定义。
   ...
   // 仪表盘数据表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("calculate.cockpit.dashbord.item", "CL_COK_DASHBORD_ITEM");
   ...
   // 字段仪表盘编号的定义。
   public final static SLogicFieldInfo DASHBORD_ID = new SLogicFieldInfo("DASHBORD_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`DASHBORD_ID`,`DATE_SEGMENT`,`RATE`,`PARAMETER1`,`PARAMETER2`,`PARAMETER3`,`PARAMETER4`,`PARAMETER5`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造仪表盘数据表逻辑单元。</T>
   //============================================================
   public FCalculateCockpitDashbordItemLogic(){
      _name = TABLE.name();
      _classUnit = FCalculateCockpitDashbordItemUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FCalculateCockpitDashbordItemLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FCalculateCockpitDashbordItemUnit.class;
   }
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FCalculateCockpitDashbordItemUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FCalculateCockpitDashbordItemUnit>(FCalculateCockpitDashbordItemUnit.class, _logicContext);
   }
   ...
   // @return 数据单元
   //============================================================
   public FCalculateCockpitDashbordItemUnit findByGuid(CharSequence guid){
      return findByGuid(null, FCalculateCockpitDashbordItemUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FCalculateCockpitDashbordItemUnit search(CharSequence whereSql){
      return search(null, FCalculateCockpitDashbordItemUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateCockpitDashbordItemUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateCockpitDashbordItemUnit> fetch(int pageSize,
                                                                 int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateCockpitDashbordItemUnit> fetch(CharSequence fields,
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateCockpitDashbordItemUnit> fetchSql(CharSequence code,
                                                                    CharSequence sql,
                                                                    int pageSize,
                                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateCockpitDashbordItemUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FCalculateCockpitDashbordItemUnit doPrepare(){
      FCalculateCockpitDashbordItemUnit unit = new FCalculateCockpitDashbordItemUnit();
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FCalculateCockpitDashbordItemUnit unit = (FCalculateCockpitDashbordItemUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append('\'');
      cmd.append(',');
      long dashbordId = unit.dashbordId();
      if(dashbordId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(dashbordId);
      }
      cmd.append(',');
