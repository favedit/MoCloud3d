...
//============================================================
@ASourceMachine
public class FDataControlCockpitModuleUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造驾驶舱模块关联逻辑单元。</T>
   //============================================================
   public FDataControlCockpitModuleUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isClassNameChanged(){
      return !RString.equals(__className, _className);
   }
   ...
   //============================================================
   @Override
   public FDataControlCockpitModuleUnit clone(){
      FDataControlCockpitModuleUnit unit = RClass.newInstance(FDataControlCockpitModuleUnit.class);
      copy(unit);
      return unit;
   }
}
