      ...
      extends FLogicTable
{
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FDataResourceModelSkeletonSkinStreamUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit>(FDataResourceModelSkeletonSkinStreamUnit.class, _logicContext);
   }
