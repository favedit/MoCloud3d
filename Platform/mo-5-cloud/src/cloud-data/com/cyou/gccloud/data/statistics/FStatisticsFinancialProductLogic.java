...
//============================================================
@ASourceMachine
public class FStatisticsFinancialProductLogic
      extends FLogicTable
{
   // 统计产品表的定义。
   ...
   // 统计产品表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("statistics.financial.product", "ST_FIN_PRODUCT");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`CODE`,`RATE`,`INVESTMENT_BEGIN_DATE`,`INVESTMENT_END_DATE`,`INVESTMENT_COUNT`,`INVESTMENT_USER_COUNT`,`INVESTMENT_TOTAL`,`REDEMPTION_BEGIN_DATE`,`REDEMPTION_END_DATE`,`REDEMPTION_COUNT`,`REDEMPTION_USER_COUNT`,`REDEMPTION_TOTAL`,`INTEREST_TOTAL`,`NETINVESTMENT_TOTAL`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造统计产品表逻辑单元。</T>
   //============================================================
   public FStatisticsFinancialProductLogic(){
      _name = TABLE.name();
      _classUnit = FStatisticsFinancialProductUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FStatisticsFinancialProductLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FStatisticsFinancialProductUnit.class;
   }
   ...
   protected <T extends FLogicUnit> T innerCreateUnit(){
      return (T)new FStatisticsFinancialProductUnit();
   }
   ...
   protected <T extends FLogicUnit> FLogicDataset<T> innerCreateDataset(){
      return (FLogicDataset<T>)new FLogicDataset<FStatisticsFinancialProductUnit>(FStatisticsFinancialProductUnit.class, _logicContext);
   }
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductUnit findByGuid(CharSequence guid){
      return findByGuid(null, FStatisticsFinancialProductUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductUnit search(CharSequence whereSql){
      return search(null, FStatisticsFinancialProductUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductUnit> fetch(int pageSize,
                                                               int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductUnit> fetch(CharSequence fields,
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductUnit> fetchSql(CharSequence code,
                                                                  CharSequence sql,
                                                                  int pageSize,
                                                                  int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialProductUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialProductUnit doPrepare(){
      FStatisticsFinancialProductUnit unit = new FStatisticsFinancialProductUnit();
