...
//============================================================
@ASourceMachine
public class FCalculateCockpitDashbordItemUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段仪表盘编号的定义。
   private long __dashbordId;

   // 字段仪表盘编号的定义。
   protected long _dashbordId;
   ...
   // <T>构造仪表盘数据表逻辑单元。</T>
   //============================================================
   public FCalculateCockpitDashbordItemUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isDashbordIdChanged(){
      return __dashbordId != _dashbordId;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setDashbordId(long value){
      _dashbordId = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "guid":
            return _guid;
         case "dashbord_id":
            return Long.toString(_dashbordId);
         case "date_segment":
            return _dateSegment;
         case "rate":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "guid":
               ...
               break;
            case "dashbord_id":
               __dashbordId = RLong.parse(value);
               _dashbordId = __dashbordId;
               break;
            case "date_segment":
               __dateSegment = value;
   ...
   public void save(FRow row){
      ...
      row.set("ovld", _ovld);
      row.set("guid", _guid);
      row.set("dashbordId", _dashbordId);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("guid", _guid);
      map.put("dashbordId", RLong.toString(_dashbordId));
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setOvld(_ovld);
      unit.setGuid(_guid);
      unit.setDashbordId(_dashbordId);
   ...
   //============================================================
   @Override
   public FCalculateCockpitDashbordItemUnit clone(){
      FCalculateCockpitDashbordItemUnit unit = RClass.newInstance(FCalculateCockpitDashbordItemUnit.class);
      copy(unit);
      return unit;
   }
}
