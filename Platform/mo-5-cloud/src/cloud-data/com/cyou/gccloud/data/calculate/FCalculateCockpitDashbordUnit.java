...
//============================================================
@ASourceMachine
public class FCalculateCockpitDashbordUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造仪表盘逻辑单元。</T>
   //============================================================
   public FCalculateCockpitDashbordUnit(){
   }
   ...
   //============================================================
   @Override
   public FCalculateCockpitDashbordUnit clone(){
      FCalculateCockpitDashbordUnit unit = RClass.newInstance(FCalculateCockpitDashbordUnit.class);
      copy(unit);
      return unit;
   }
}
