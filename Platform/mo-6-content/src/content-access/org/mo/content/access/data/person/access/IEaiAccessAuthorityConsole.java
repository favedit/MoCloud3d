...
// <T>数据人员访问授权信息控制台接口。</T>
//============================================================
public interface IEaiAccessAuthorityConsole
      extends
         IAbstractLogicUnitConsole<FEaiAccessAuthorityInfo>
{
   //============================================================
   // <T>根据登录账号信息查找授权信息。</T>
   //
   ...
   // @return 授权信息
   //============================================================
   FEaiAccessAuthorityInfo findByPassport(ILogicContext logicContext,
                                          String passport);
   ...
   // @return 授权信息
   //============================================================
   FEaiAccessAuthorityInfo findByHostAddress(ILogicContext logicContext,
                                             String hostAddress);
   ...
   // @return 登录结果
   //============================================================
   int cockpitDoLogin(ILogicContext logicContext,
                      String passport,
                      String password);
}
