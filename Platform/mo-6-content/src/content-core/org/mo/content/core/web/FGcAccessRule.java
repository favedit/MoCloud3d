...
import org.mo.web.protocol.common.FWebAccessRule;
import org.mo.web.protocol.context.IWebContext;

//============================================================
// <T>网站权限访问规则。</T>
//============================================================
public class FGcAccessRule
      extends FWebAccessRule
{
   ...
   public EResult checkSession(IWebContext context,
      ...
      FGcSession session = (FGcSession)context.session();
      if(session == null){
         return EResult.Failure;
      }
      // 绑定数据
      bindConsole().bind(FGcSession.class, session);
